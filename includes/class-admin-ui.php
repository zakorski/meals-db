        ...
        <form method="post" id="mealsdb-client-form" class="<?php echo esc_attr($form_class_attr); ?>">
            ...
            <div class="mealsdb-form-columns">
                <div class="mealsdb-column col-1">
                    <div class="mealsdb-section">
                        <h3><?php esc_html_e('Identity', 'meals-db'); ?></h3>
                    ...
                    <div class="mealsdb-section">
                        <h3><?php esc_html_e('Contact Information', 'meals-db'); ?></h3>
                        <table class="form-table">
                ...
                <div class="mealsdb-column col-2">
                    <div class="mealsdb-section">
                        <h3><?php esc_html_e('Address', 'meals-db'); ?></h3>
                        <table class="form-table">
                            <tr data-required-for="sdnb,veteran,private">
                    ...
                    <div class="mealsdb-section">
                        <h3><?php esc_html_e('Service & Delivery', 'meals-db'); ?></h3>
                        <table class="form-table">
                            <tr data-required-for="sdnb,veteran,private">
                    ...
                    <div class="mealsdb-section" data-client-type="sdnb">
                        <h3><?php esc_html_e('Requisition Details (SDNB)', 'meals-db'); ?></h3>
                        <table class="form-table">
                            <tr>
                ...
                <div class="mealsdb-column col-3">
                    <div class="mealsdb-section" data-client-type="sdnb">
                        <h3><?php esc_html_e('SDNB Program Details', 'meals-db'); ?></h3>
                        <table class="form-table">
                            <tr>
                    ...
                    <div class="mealsdb-section" data-client-type="veteran">
                        <h3><?php esc_html_e('Veteran Details', 'meals-db'); ?></h3>
                        <table class="form-table">
                    ...
                    <div class="mealsdb-section">
                        <h3><?php esc_html_e('Delivery Initials & Notes', 'meals-db'); ?></h3>
                        <table class="form-table">
                            <tr data-client-type="sdnb,veteran,private" data-required-for="sdnb,veteran,private">
