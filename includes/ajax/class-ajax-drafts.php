<?php
/**
 * AJAX handlers for client draft interactions.
 *
...
class MealsDB_Ajax_Drafts {
    ...
    public function __construct() {
        add_action('wp_ajax_mealsdb_save_draft', [$this, 'save_draft']);
        add_action('wp_ajax_mealsdb_delete_draft', [$this, 'delete_draft']);
    }
