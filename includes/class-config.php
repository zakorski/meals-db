...
class MealsDB_Config
{
    ...
    {
        // ABSPATH ends in `/wp-admin/` or the site root; using dirname of index.php hits the WP root.
    ...
    /**
     * PUBLIC GETTERS (used everywhere else)
     */
    public function db_host(): string { return $this->db_host; }
    public function db_user(): string { return $this->db_user; }
    public function db_pass(): string { return $this->db_pass; }
    public function db_name(): string { return $this->db_name; }
    public function table_prefix(): string { return $this->table_prefix; }
}
